      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex justify-center gap-6">
            <a 
              href="https://www.facebook.com/share/1B92uC2pnV/?mibextid=wwXlfr" 
              target="_blank" 
            ...
            <a 
              href="https://www.instagram.com/the_ultimate_autospa?igsh=MXhkZjd6bzh4cDJ3cA==" 
              target="_blank" 
              rel="noopener noreferrer"
            ...
            <a 
              href="https://www.tiktok.com/@theultimateautospa?_t=ZM-8vXZzU9vcBj&_r=1" 
              target="_blank" 
              rel="noopener noreferrer"
              aria-label="TikTok"
            >
