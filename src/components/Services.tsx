...
const servicePackages = [
  ...
  },
  {
    ...
    popular: true,
    icon: "✨",
    id: "premium-package" // Updated ID to match expected ID in Index.tsx
  },
  {
    name: "Full Spa",
    price: "D2500",
    ...
    popular: false,
    icon: "💎",
    id: "full-spa-package" // Updated ID to match expected ID in Index.tsx
  },
  {
    name: "The Ultimate",
    price: "D5000",
    ...
    popular: false,
    icon: "👑",
    id: "ultimate-package" // Updated ID to match expected ID in Index.tsx
  }
];
...
const Services = () => {
  ...
  const handleServiceSelection = (serviceId: string) => {
    ...
    if (contactSection) {
      ...
      // Post message to inform about service selection
      window.postMessage({ serviceType: serviceId }, "*");
      console.log("Posted message for service:", serviceId);
    }
  };
    ...
    <section id="services" className="py-20 bg-autospa-lightgray">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h2 className="text-4xl font-bold mb-4 text-autospa-black">Our <span className="text-autospa-yellow">Services</span></h2>
          ...
          {servicePackages.map((pkg, index) => {
            ...
            return (
              <div 
                ...
                id={pkg.id}
                onClick={() => handleServiceSelection(pkg.name)}
                onMouseEnter={() => {
              ...
              >
                <Card 
                  className={`overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 ${pkg.popular ? 'border-autospa-yellow ring-2 ring-autospa-yellow/20 relative' : 'border-gray-200'} cursor-pointer`}
                >
                  {pkg.popular && (
