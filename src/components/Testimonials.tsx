...
const Testimonials = () => {
  return <section id="testimonials" className="py-20 bg-autospa-lightgray">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 text-autospa-yellow">Customer <span className="text-autospa-yellow">Testimonials</span></h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {testimonials.map((testimonial, index) => <div key={index} className="bg-white p-6 rounded-lg shadow-md transition-all duration-300 hover:shadow-xl border-t-4 border-autospa-yellow">
