      ...
      <div className="border-t border-gray-800">
        <div className="container mx-auto px-4 py-4 flex flex-wrap justify-between items-center">
          <div className="flex flex-col sm:flex-row items-center space-x-0 sm:space-x-4 mb-4 sm:mb-0">
            <a href="https://www.facebook.com/share/1B92uC2pnV/?mibextid=wwXlfr" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-autospa-yellow transition-colors">
              <span className="sr-only">Facebook</span>
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
              </svg>
            </a>
            <a href="https://www.instagram.com/the_ultimate_autospa?igsh=MXhkZjd6bzh4cDJ3cA==" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-autospa-yellow transition-colors">
            ...
            <p className="text-[#0EA5E9] mt-2 sm:mt-0 sm:ml-4 font-medium">sla was here</p>
          </div>
