...
const Contact = () => {
  ...
  useEffect(() => {
    const handleMessage = (event: MessageEvent) => {
      ...
      if (event.data && event.data.serviceType) {
        // Send message to JotForm iframe to select the appropriate service
        ...
        if (iframeWindow) {
          ...
          try {
            ...
            console.log('Message sent to iframe:', event.data.serviceType);
          } catch (error) {
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">220 7898519</p>
                  </div>
                </div>
